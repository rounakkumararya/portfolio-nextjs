...
import { FaArrowRight, FaBehance, FaGithub, FaLinkedin } from "react-icons/fa6";
...
function ProjectMenu() {
    ...
    return (
        <React.Fragment>
            ...
            >
                <MenuHandler>
                    <Typography as="a" href="#projects" variant="small" className="font-medium">
                        <ListItem
...
function NavList() {
    return (
        <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1">
            ...
            >
                <ListItem className=" group flex items-center gap-2 py-2 pr-4">
    ...
    const renderItems =
        <React.Fragment>
            ...
            <div className="m-2 flex gap-2  ">
                <Typography as="a" href="https://www.linkedin.com/in/rounak-kumar-arya/" target="_blank" color="blue-gray" className="hover:text-blue-600 flex items-center gap-2   mb-1">
                    <FaLinkedin />
                </Typography>
            </div>
        </React.Fragment>
    ...
    return (
        <React.Fragment>
            <Menu allowHover open={isMenuOpen} handler={setIsMenuOpen}>
                <MenuHandler>
                    <Typography as="a" href="#about" variant="small" className="font-normal">
                        <MenuItem className="group hidden items-center gap-2 font-medium text-blue-gray-900 lg:flex lg:rounded-full">
                ...
                <MenuList className="hidden w-[36rem] cursor-text grid-cols-7 gap-3 overflow-visible lg:grid">
                    <Card
            ...
            <MenuItem className="group flex items-center gap-2 font-medium text-blue-gray-900 lg:hidden">
                <GiAstronautHelmet className="group-hover:text-red-600 group-hover:animate-bounce" />{" "}
                About Me{" "}
            </MenuItem>
...
export function NavbarWithMegaMenu() {
    ...
    return (
        <Navbar fullWidth shadow={false} className="backdrop-blur-md border-0 sticky top-0 z-50 ">
            <div className="text-black container mx-auto flex items-center justify-between" >
                ...
                <div className="hidden gap-2 lg:flex">
                    <Link href="https://github.com/rounakkumararya/" target="_blank">
                        ...
                        <Button className="flex align-middle gap-1 items-center text-center" variant="text"><FaGithub size={18} />Github</Button>
                    </Link>
                    <Link href="" target="_blank">
                        <Button className="flex align-middle gap-1 items-center text-center" color="gray"><HiDocumentArrowDown size={18} /> Resume</Button>
                    </Link>
                </div>
                <IconButton
                    variant="text"
            ...
            <Collapse open={openNav}>
                ...
                <div className="flex w-full flex-nowrap items-center gap-2 lg:hidden">
                    <Link href="https://github.com/rounakkumararya/" target="_blank">
                        <Button className="flex align-middle gap-1 items-center text-center" variant="text"><FaGithub size={16} />Github</Button>
                    </Link>
                    <Link href="" target="_blank">
                        <Button className="flex align-middle gap-1 items-center text-center" color="gray"><HiDocumentArrowDown size={16} /> Resume</Button>
                    </Link>
                </div>
            </Collapse>
        </Navbar >
